...
ADDR_PRO_POSITION_MAX_LIMIT = 48
ADDR_PRO_POSITION_MIN_LIMIT = 52
ADDR_PRO_GOAL_POSITION      = 116
ADDR_PRO_PRESENT_POSITION   = 132
ADDR_PRO_VELOCITY_PROFILE   = 112
ADDR_PRO_ACC_PROFILE        = 108
ADDR_PRO_DRIVE_MODE         = 10
ADDR_PRO_OPERA_MODE         = 11
...
DEVICENAME                  = 2                 # Check which port is being used on your controller
...
# set position limit to full range
dxl_comm_result, dxl_error = packetHandler.write4ByteTxRx(portHandler, DXL_ID, ADDR_PRO_POSITION_MIN_LIMIT, 0)
if dxl_comm_result != COMM_SUCCESS:
    print("%s" % packetHandler.getTxRxResult(dxl_comm_result))
elif dxl_error != 0:
    print("%s" % packetHandler.getRxPacketError(dxl_error))
dxl_comm_result, dxl_error = packetHandler.write4ByteTxRx(portHandler, DXL_ID, ADDR_PRO_POSITION_MAX_LIMIT, 4095)
if dxl_comm_result != COMM_SUCCESS:
    print("%s" % packetHandler.getTxRxResult(dxl_comm_result))
elif dxl_error != 0:
    print("%s" % packetHandler.getRxPacketError(dxl_error))
...
dxl_goal_position = 2048 #180 degree
